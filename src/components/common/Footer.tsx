          ...
          <div className="space-y-8">
            ...
            <div className="space-y-4">
              ...
              <div className="flex items-start space-x-2">
                ...
                <span className="text-sm text-muted-foreground">
                  5/4, Solimollah Road, Mohammadpur, Dhaka, Bangladesh
                </span>
              </div>
              <div className="flex space-x-3">
                <Link
                  to="https://facebook.com/f.a.masum"
                  target="_blank"
                  aria-label="Facebook"
                >
                ...
                <Link
                  to="https://twitter.com/f.a.masum"
                  target="_blank"
                  aria-label="Twitter"
                >
                ...
                <Link
                  to="https://github.com/developerMasum"
                  target="_blank"
                  aria-label="GitHub"
                >
                  <svg
                ...
                <Link
                  to="https://instagram.com/f.a.masum"
                  target="_blank"
                ...
                <Link
                  to="https://youtube.com/@f.a.masum"
                  target="_blank"
                  aria-label="YouTube"
                >
      ...
      <div className="w-full bg-gray-900 text-white py-4">
        <section className="px-4 flex flex-col md:flex-row justify-between items-center">
          <div className="flex space-x-4 mb-4 md:mb-0">
            ...
            <Link
              to="https://github.com/junayet4o12"
              target="_blank"
              aria-label="GitHub"
            >
              <svg
